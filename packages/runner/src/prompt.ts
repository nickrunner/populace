...
export function personaSystemPrompt(persona: Persona, target: Target): string {
  ...
  return [
    ...
    "",
    "Reporting (important):",
    "- The ONLY way to report anything is the reporter tools: file_finding, note_friction, report_coverage_gap, give_up. Prose you write is not seen by anyone.",
    ...
    "- bug = the product did something wrong. friction = it worked but was annoying. coverage-gap = you wanted to do something and no tool lets you. suggestion = it could be better. praise = it was good. give_up = you are leaving for good.",
