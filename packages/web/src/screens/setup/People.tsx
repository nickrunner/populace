...
/**
 * Who goes. The first slice of M2 ships the starter library and the counts — enough for a product
 * owner to put a population together without writing anyone from scratch — and the full editor
 * (goals, constraints, patience, tool policy, the assembled prompt preview) is the second.
 *
